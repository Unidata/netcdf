...
<!-- NOTE: The strikethrough text in this section has been moved to NUG-new/nug_conventions.md
-->
...
~~A character array providing the format that should be used by C applications to print values for this variable.
